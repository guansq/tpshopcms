...
class Produce extends Base
{
    ...
    {
        $this->assign("URL_upload", U('Admin/Ueditor/imageUp', ['savepath' => 'produce']));
        $this->assign("URL_fileUp", U('Admin/Ueditor/fileUp', ['savepath' => 'produce']));
        $this->assign("URL_scrawlUp", U('Admin/Ueditor/scrawlUp', ['savepath' => 'produce']));
        $this->assign("URL_getRemoteImage", U('Admin/Ueditor/getRemoteImage', ['savepath' => 'produce']));
        $this->assign("URL_imageManager", U('Admin/Ueditor/imageManager', ['savepath' => 'produce']));
        $this->assign("URL_imageUp", U('Admin/Ueditor/imageUp', ['savepath' => 'produce']));
        $this->assign("URL_getMovie", U('Admin/Ueditor/getMovie', ['savepath' => 'produce']));
